...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Vector Web Development">
        <meta name="keywords" content="Web Agency Birmingham AL">
    ...
    <body ng-app="hspc" ng-controller="hspc.controller as $ctrl" id="top" class="has-header-search">
                ...
                <div class="container">
                    ...
                    <div id="materialize-menu" class="menuzord">
                        ...
                        <a href="index.html" class="logo-brand">
                            <img class="retina" src="assets/img/vector-logo.png" alt="" />
                        </a>
                        <!--logo end-->
          ...
          <ul>
            ...
            <li data-transition="fade" data-slotamount="default" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="assets/img/banner-1/bg.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="materialize Material" data-description="">
                ...
                <div class="tp-caption tp-resizeme rev-subheading white-text text-center"
                    ...
                    <h3 style="font-size: 23px; color: white; font-weight: bold">Schedule a free consultation today.</h3>
			        Vector Web Development is a Birmingham-based web development agency
                    <br/> specializing in dynamic web applications.
                </div>
        ...
        <!-- ABOUT SECTION
        ============================= -->
        <section id="about" class="parallax-bg banner-5 bg-fixed overlay dark-5 padding-top-100" data-stellar-background-ratio="0.5">
            <div class="container">
              <div class="mb-80 text-center">
                  <h2 class="font-30 white-text text-extrabold text-uppercase">What we Do</h2>
                	...
                	<div class="booking-form-wrapper">
                    	...
                    	<form name="contact-form" class="clearfix" ng-submit="$ctrl.register($event)">
	                      ...
	                      <div class="row">
                            ...
                            <button type="submit" name="submit" class="waves-effect waves-light btn mt-30">Register Now</button>
                    	</form>
                	</div>
                </div><!-- /.col-md-6 -->
              </div><!-- /.row -->
        ...
        <footer class="footer footer-five">
            ...
            <div class="secondary-footer grey lighten-4">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <span class="copy-text">Copyright 2018 <a href="#">Vector Applications LLC</a></span>
                        </div>
                        <div class="col-md-6">
                            <ul>
                                <li><a href="#">Home</a></li>
